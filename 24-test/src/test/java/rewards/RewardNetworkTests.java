 ...
 * - Run the test again.
 */
// @SpringJUnitConfig(TestInfrastructureConfig.class) // Cấu hình Spring TestContext Framework với lớp cấu hình TestInfrastructureConfig
@SpringJUnitConfig // Cấu hình Spring TestContext Framework, Spring sẽ tự động tìm kiếm lớp cấu hình bên trong lớp test này
// @ActiveProfiles("stub") // Chỉ kích hoạt profile "stub" cho test này
// @ActiveProfiles({"jdbc", "local"}) // Kích hoạt cả profile "jdbc" và "local" cho test này
@ActiveProfiles({"jdbc", "jndi"}) // Kích hoạt cả profile "jdbc" và "jndi" cho test này
public class RewardNetworkTests {

	/**
	 * The object being tested.
	 */
	@Autowired // Sử dụng @Autowired để tự động tiêm RewardNetwork từ Spring Application Context
