...
public class JdbcRestaurantRepository implements RestaurantRepository {
	...
	public Restaurant findByMerchantNumber(String merchantNumber) {
		...
		// Câu lệnh trên sẽ thực hiện truy vấn SQL với tham số merchantNumber, sử dụng phương thức mapRestaurant để ánh xạ kết quả trả về thành đối tượng Restaurant.
