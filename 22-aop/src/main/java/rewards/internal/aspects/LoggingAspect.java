...
public class LoggingAspect {
	...
	@Before("execution(* rewwards.internal..*Repository.find*(..))") // Chọn tất cả các phương thức bắt đầu bằng "find" trong các lớp Repository
	...
	@Around("execution(* rewards.internal..*Repository.update*(..))") // Chọn tất cả các phương thức bắt đầu bằng "update" trong các lớp Repository
	public Object monitor(ProceedingJoinPoint repositoryMethod) throws Throwable {
		...
		try {
			...
			return repositoryMethod.proceed(); // Thực hiện phương thức gốc và trả về kết quả
