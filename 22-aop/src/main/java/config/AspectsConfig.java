...
@ComponentScan("rewards.internal.aspects") // Quét các thành phần trong gói rewards.internal.aspects
@EnableAspectJAutoProxy // Kích hoạt hỗ trợ AspectJ Auto Proxy
